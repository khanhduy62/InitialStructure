...
const ContactComponent = props => {
    ...
    return (
        <View style={{ flex: 1, flexDirection: 'column', margin: 40, justifyContent: 'flex-start', }}>
            ...
            <Field name="username" keyboardType="default" label="Username: " component={MyTextInput} />
            <Field name="email" keyboardType="email-address" label="Email: " component={renderField} />
            <Field name="age" keyboardType="numeric" label="Age: " component={renderField} format={phoneFormatter} />
